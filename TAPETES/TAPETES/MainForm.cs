...
namespace TAPETES
{
    ...
    { 
        ...
        decimal totalAlimentos = numeroIntegrantes*(+costoFlores);
       ...
       decimal PrecioFinal = totalAserrin+totalflores+totalAlimentos+totalAgua+totalDiseño+totalManoDeObra;

        // Mostrar el resultado
        lblPrecioFinal.Text = "El precio del tapete es: " + PrecioFinal.ToString("C");
    }
    catch (FormatException)
    {
        MessageBox.Show("Error, ingresa valores válidos por favor y gracias!!.");
    }
}
